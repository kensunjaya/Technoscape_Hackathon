    ...
    <>
      ...
      <div className="w-screen min-h-screen flex font-sans bg-background">
        ...
        <div className="mx-10 py-5 flex items-end justify-start">
          <div>
            <div className="my-5 text-white bg-blueres p-5 rounded-3xl w-[50%]">
              {response}
            </div>
            <div className="flex">
              <input
                ...
                className="p-3 rounded-xl bg-bluefield text-white min-w-[100vh] font-sans mr-5"
                value={prompt}
                onChange={(e) => setPrompt(e.target.value)}
              />
              <button
                onClick={getResponse}
                className="rounded-xl text-black bg-white"
              >
                Send
              </button>
            </div>
